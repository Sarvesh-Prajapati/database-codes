...
-- #######################################################################################################################################
-- ----------------------- COMPLEX QUERIES (Ankit Bansal YT Channel : https://www.youtube.com/watch?v=rFsgzSeG1X0) -----------------------
-- Tables used : ab_employees, ab_salary_history

-- --------- Create and populate ab_employees table
...
-- --------- Create and populate salary_history table
